...
- Report live-capture frame deltas against the previous retained frame, so heartbeat frames no longer claim `0%` after a visible below-threshold edit; preserve nonzero sub-hundredth percentages in human output.
