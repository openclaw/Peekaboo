...
- Claim and generation-check the host's ScreenCaptureKit lease before routing background Bridge full-screen automatic capture directly through the concurrent engine, preserving automatic fallback on every claim failure or competing owner.
