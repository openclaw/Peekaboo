...
- Scope persistent MCP and Agent browser page and element references to their caller, exact connection, page, snapshot, and navigation generation, rejecting cross-session or stale capabilities before dispatch.
