...
test("hosted text route proof runs isolated SDK and background contracts with nonempty guards", () => {
  ...
  assert.ok(step.includes("set -euo pipefail"));
  assert.ok(step.includes("filter='^PeekabooAutomationKitTests[.](TextInputRouteTests|TypeServiceForegroundPolicyTests|BackgroundTextInputDeliveryTests|BackgroundTextRouteRefusalTests|BackgroundTextInputReceiverTests)/'"));
