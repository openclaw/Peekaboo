...
/// Selects the text delivery mechanism; exact-window ownership remains the caller's responsibility.
enum BackgroundTextInputRoute: Equatable {
    case nativeAX
    case webKeyboard
    case unproven
    ...
    func permitsAccessibilityEditing() throws -> Bool {
        ...
        case .unproven:
            throw DesktopActionFailure.preDispatchRefusal(
                ...
                message: "Background text input could not prove the focused control's delivery route.",
