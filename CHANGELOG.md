...
- Scope MCP and Agent browser page and element references to their caller, exact connection, page, snapshot, and navigation generation; reject cross-session or stale capabilities before dispatch and let independently authenticated local browser sessions progress concurrently.
