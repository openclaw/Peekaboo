...
- Add process-local MCP/Agent and durable Bridge 1.38 browser namespaces that bind opaque Chrome page capabilities to exact native PID-generation/window receipts, with final tab/window revalidation before every bound mutation and no raw CDP ID disclosure.
