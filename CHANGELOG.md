...
- Verify dialog input against the retained exact field without claiming global-event causality, propagate focus/clear/typing/cancellation failures, and keep forced global Escape dismissal retry-unsafe and unverified with an exact PID/generation/window receipt even if another controller closes the dialog.
