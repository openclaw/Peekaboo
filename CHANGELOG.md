...
- Make `app:restart` transactionally install the newly built signed companion app, preserve its TCC identity, refuse AppleScript-capable payloads, launch without activation, and restore the previous bundle on failure.
