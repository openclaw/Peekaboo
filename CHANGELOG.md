...
- Daemon startup coordination and child cleanup are now bounded: the shared startup lock is securely opened, cannot leak into spawned daemons, and honors cancellation and timeouts; child termination uses bounded TERM and SIGKILL phases instead of an unbounded Foundation wait.
