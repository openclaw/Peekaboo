...
- Connect to approval-mode Chrome with one persistent WebSocket for verification and page operations; explain HTTP discovery 404s and refuse silent reconnection or endpoint redirects. Thanks @steipete for the report!
