...
- A daemon that wedges during startup cleanup can no longer hang `peekaboo daemon start` indefinitely after its readiness timeout; child termination now has bounded TERM and SIGKILL phases.
