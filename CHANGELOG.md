...
- Require direct accessibility actions and value mutations to resolve through a current or freshly targeted UI snapshot, refusing before dispatch instead of falling through to the user's frontmost app.
