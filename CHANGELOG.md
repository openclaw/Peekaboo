...
- Bind dialog input to an exact PID/generation/window/sheet/field through capability-gated Bridge protocol 1.27, revalidate focus before every global keyboard event without claiming causality, and keep forced Escape dismissal retry-unsafe even if another controller closes the dialog.
