...
- Transport selection uses application metadata without reading the app executable. Only otherwise eligible native wheel targets receive the bounded WebKit-import probe; classification is not cached across operations.
