...
| --- | --- | --- |
| `launch` | Start an app by name/path/bundle ID in the background, optionally opening documents. | `--bundle-id`, `--open <path|url>` (repeatable), `--new-instance`, `--wait-until-ready`, `--wait-for-window`, `--foreground`. |
