...
| Core Swift packages | macOS 14.0+ package metadata | Core package manifests such as [`Core/PeekabooCore/Package.swift`](../Core/PeekabooCore/Package.swift) declare `.macOS(.v14)`, but host features that capture screens, inspect windows, control Spaces, or drive Accessibility follow the CLI/app requirements. |
